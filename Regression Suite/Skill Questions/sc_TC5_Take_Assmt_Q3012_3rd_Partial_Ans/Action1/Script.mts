'File Name: sc_TC5_Take_Assmt_Q3012_3rd_Partial_Ans
...
'--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
' Step No.   		        :  1
' Description           :   Login to Precision LMS with the user "prof_pt_co3_usr_0204@ptcunoemail.com and Password as <prof7763>
...
Browser("Browser").Page("Page").Login  "prof_pt_co3_usr_0204@ptcunoemail.com", "prof7763" , blnRet
If  blnRet = false Then
		ExitAction(0)
End If
...
'-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
' Step No.   		        :  5
' Description           :   Validate and answer question 3012 with 3rd partial answer and Click Submit Entire Assessment
'                                      Note :-Models can be uploaded from Location D:\Temp\Skill_Qs_Regression from Machine I2361
' Expected Result  : As Expected it should show "Ok" button in light box after answering to  the questions.
Reporter.ReportEvent 2, "STEP 5 BEGINS",""

Browser("Assessment Viewer").Page("Assessment Viewer").Link("Question 1").Click
Browser("Assessment Viewer").Page("Assessment Viewer").Sync
Browser("Assessment Viewer").Page("Assessment Viewer").Link("Question 19").Click
Browser("Assessment Viewer").Page("Assessment Viewer").Sync
Wait(5)
Browser("Assessment Viewer").Page("Assessment Viewer").WebFile("response:fileUploads:0:modelFi").Set "D:\Temp\Skill_Qs_Regression\3012\partial-popup\q3012_test.prt.2"
Browser("Assessment Viewer").Page("Assessment Viewer").Sync
Wait(5)
Browser("Assessment Viewer").Page("Assessment Viewer").Link("Submit entire assessment").Click
Browser("Assessment Viewer").Page("Assessment Viewer").Sync
...
Browser("Browser").Page("Page").WebElement("3%").Check CheckPoint("Score") @@ hightlight id_;_Browser("Browser").Page("Page").WebElement("3%")_;_script infofile_;_ZIP::ssf187.xml_;_
Browser("Browser").Page("Page").WebElement("25").Check CheckPoint("No Of Qs") @@ hightlight id_;_Browser("Browser").Page("Page").WebElement("No Of Qs")_;_script infofile_;_ZIP::ssf188.xml_;_
Browser("Browser").Page("Page").WebElement("1").Check CheckPoint("Answered") @@ hightlight id_;_Browser("Browser").Page("Page").WebElement("1")_;_script infofile_;_ZIP::ssf189.xml_;_
Browser("Browser").Page("Page").WebElement("0").Check CheckPoint("Correct") @@ hightlight id_;_Browser("Browser").Page("Page").WebElement("0")_;_script infofile_;_ZIP::ssf190.xml_;_
...
Browser("Browser").Page("Page").Check CheckPoint("Answers Tab")

Browser("Browser").Page("Page").Link("Question 19").Click
Wait(10)
value = Browser("creationtime:=1").GetROProperty("hwnd")
Browser("Assessment Viewer").SetToProperty "hwnd", value
Browser("Assessment Viewer").Page("Assessment Viewer").Sync
Wait(5)
Browser("Assessment Viewer").Page("Assessment Viewer").WebElement("Partially Correct").Check CheckPoint("Partially Correct") @@ hightlight id_;_Browser("Assessment Viewer").Page("Assessment Viewer").WebElement("Partially Correct")_;_script infofile_;_ZIP::ssf195.xml_;_
Browser("Assessment Viewer").Page("Assessment Viewer").WebElement("70%").Check CheckPoint("70%") @@ hightlight id_;_Browser("Assessment Viewer").Page("Assessment Viewer").WebElement("70%")_;_script infofile_;_ZIP::ssf196.xml_;_
Browser("Assessment Viewer").Page("Assessment Viewer").WebTable("Result").Check CheckPoint("Result") @@ hightlight id_;_Browser("Assessment Viewer").Page("Assessment Viewer").WebTable("Result")_;_script infofile_;_ZIP::ssf197.xml_;_
Browser("Assessment Viewer").Page("Assessment Viewer").Link("Click Here").Click
Browser("Assessment Viewer").Page("Assessment Viewer").Sync
Wait(5)
Browser("Detail of Actual Result").Page("Detail of Actual Result").Check CheckPoint("Detail of Actual Result")
Browser("Detail of Actual Result").Page("Detail of Actual Result").Sync
Wait(5)
Browser("Detail of Actual Result").Close
Browser("Assessment Viewer").Page("Assessment Viewer").Sync
Wait(5)
Browser("Assessment Viewer").Close
Browser("Browser").Page("Page").Check CheckPoint("Assessment Result_2")
