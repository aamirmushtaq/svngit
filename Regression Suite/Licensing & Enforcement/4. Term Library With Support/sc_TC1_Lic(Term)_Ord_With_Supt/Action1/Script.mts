'File Name: sc_TC1_Licen(Term)_Ord_With_Suppt
...
'  Author:  Ravi Kishore
'  Date Started Creation: 09/05/2008
'  Date Ended Creation: 09/05/2008
...
'                                 All the License Details should set as mentioned below Number Of Users =10 License Type = Term Term Expiration Date = Some furture Date Support  = Yes Support expiration Date = Some future Date.
...
Reporter.ReportEvent 2, "STEP 10 -15 BEGINS","" @@ hightlight id_;_1051066_;_script infofile_;_ZIP::ssf108.xml_;_
...
Browser("Browser").Page("Page").Sync @@ hightlight id_;_Browser("Browser").Page("Page").WebEdit("customerInput:customerNumber")_;_script infofile_;_ZIP::ssf240.xml_;_
Browser("Browser").Page("Page").WebEdit("customerInput:customerNumber").Set "341"
Browser("Browser").Page("Page").Sync @@ hightlight id_;_Browser("Browser").Page("Page").Link("Select")_;_script infofile_;_ZIP::ssf241.xml_;_
Browser("Browser").Page("Page").Link("Select").Click
Browser("Browser").Page("Page").Sync @@ hightlight id_;_Browser("Browser").Page("Page").WebEdit("contactEmailId")_;_script infofile_;_ZIP::ssf242.xml_;_
Browser("Browser").Page("Page").WebEdit("contactEmailId").Set "prof_pt_co3_usr_0200@ptcunoemail.com"
Browser("Browser").Page("Page").Sync @@ hightlight id_;_Browser("Browser").Page("Page").WebEdit("salesOrderNumber")_;_script infofile_;_ZIP::ssf243.xml_;_
Browser("Browser").Page("Page").WebEdit("salesOrderNumber").Set "1"
Browser("Browser").Page("Page").Sync @@ hightlight id_;_Browser("Browser").Page("Page").WebEdit("notes")_;_script infofile_;_ZIP::ssf244.xml_;_
Browser("Browser").Page("Page").WebEdit("notes").Set "Created by rkishore"
Browser("Browser").Page("Page").Sync @@ hightlight id_;_Browser("Browser").Page("Page").Link("Add New License")_;_script infofile_;_ZIP::ssf245.xml_;_
Browser("Browser").Page("Page").Link("Add New License").Click
Browser("Browser").Page("Page").Sync
Wait(5) @@ hightlight id_;_Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebCheckBox("selectLibraryGroup")_;_script infofile_;_ZIP::ssf247.xml_;_
Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").Check CheckPoint("modal-dialog-pagemap")
Wait(5) @@ hightlight id_;_Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebCheckBox("selectLibraryGroup 2")_;_script infofile_;_ZIP::ssf248.xml_;_
Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebCheckBox("selectLibraryGroup").Set "ON"
Wait(10) @@ hightlight id_;_Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebCheckBox("isLinkLibraries")_;_script infofile_;_ZIP::ssf249.xml_;_
Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebCheckBox("selectLibraryGroup_2").Set "ON"
Wait(10) @@ hightlight id_;_Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebButton("Next")_;_script infofile_;_ZIP::ssf250.xml_;_
Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebCheckBox("isLinkLibraries").Set "ON"
Wait(10) @@ hightlight id_;_Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebEdit("usersTextBox")_;_script infofile_;_ZIP::ssf251.xml_;_
Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebButton("Next").Click
Wait(10) @@ hightlight id_;_Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebList("licenseTypeDropDown")_;_script infofile_;_ZIP::ssf252.xml_;_
Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebEdit("usersTextBox").Set "10"
Wait(10) @@ hightlight id_;_Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebList("supportDropDown")_;_script infofile_;_ZIP::ssf253.xml_;_
Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebList("licenseTypeDropDown").Select "Term"
Wait(10)
Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebEdit("licenseDateContainer:termExpDa").Check CheckPoint("licenseDateContainer:termExpDateField") @@ hightlight id_;_Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebEdit("licenseDateContainer:termExpDa")_;_script infofile_;_ZIP::ssf356.xml_;_
...
Wait(10) @@ hightlight id_;_Browser("Browser").Page("Page").WebButton("Submit")_;_script infofile_;_ZIP::ssf255.xml_;_
Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebEdit("supportDateContainer:supportEx").Check CheckPoint("supportDateContainer:supportExpDateField") @@ hightlight id_;_Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebEdit("supportDateContainer:supportEx")_;_script infofile_;_ZIP::ssf365.xml_;_
...
Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebList("select_2").Select "2018"
Wait(5)
Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebElement("WebTable").Click
Wait(5)
Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebButton("Submit_2").Click
Wait(10)
Browser("Browser").Page("Page").WebButton("Submit").Click @@ hightlight id_;_4588500_;_script infofile_;_ZIP::ssf258.xml_;_
Browser("Browser").Page("Page").Sync
Wait(5)
Browser("Browser").Dialog("Microsoft Internet Explorer").WinButton("OK").Click @@ hightlight id_;_Browser("Browser").Page("Page")_;_script infofile_;_ZIP::ssf259.xml_;_
Browser("Browser").Page("Page").Sync
Wait(5)
Browser("Browser").Page("Page").Check CheckPoint("Orders_5")
Browser("Browser").Page("Page").Sync
...
Reporter.ReportEvent 2, "STEP 16 - 19 BEGINS","" @@ hightlight id_;_Browser("Browser").Page("Page").Link("Create New Order")_;_script infofile_;_ZIP::ssf260.xml_;_

Browser("Browser").Page("Page").Link("Create New Order").Click @@ hightlight id_;_Browser("Browser").Page("Page").WebEdit("customerInput:customerNumber")_;_script infofile_;_ZIP::ssf261.xml_;_
Browser("Browser").Page("Page").Sync
Browser("Browser").Page("Page").WebEdit("customerInput:customerNumber").Set "341" @@ hightlight id_;_Browser("Browser").Page("Page").Link("Select")_;_script infofile_;_ZIP::ssf262.xml_;_
Browser("Browser").Page("Page").Sync
Browser("Browser").Page("Page").Link("Select").Click @@ hightlight id_;_Browser("Browser").Page("Page").WebEdit("contactEmailId")_;_script infofile_;_ZIP::ssf266.xml_;_
Browser("Browser").Page("Page").Sync
Browser("Browser").Page("Page").WebEdit("contactEmailId").Set "prof_pt_co3_usr_0200@ptcunoemail.com" @@ hightlight id_;_Browser("Browser").Page("Page").WebEdit("salesOrderNumber")_;_script infofile_;_ZIP::ssf264.xml_;_
Browser("Browser").Page("Page").Sync
Browser("Browser").Page("Page").WebEdit("salesOrderNumber").Set "1" @@ hightlight id_;_Browser("Browser").Page("Page").WebEdit("notes")_;_script infofile_;_ZIP::ssf265.xml_;_
Browser("Browser").Page("Page").Sync
Browser("Browser").Page("Page").WebEdit("notes").Set "created by rkishore" @@ hightlight id_;_Browser("Browser").Page("Page").Link("Add New License")_;_script infofile_;_ZIP::ssf267.xml_;_
Browser("Browser").Page("Page").Sync
Browser("Browser").Page("Page").Link("Add New License").Click
Browser("Browser").Page("Page").Sync @@ hightlight id_;_Browser("Browser").Page("Page").Frame("modal-dialog-pagemap")_;_script infofile_;_ZIP::ssf268.xml_;_
Wait(5)
Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").Check CheckPoint("modal-dialog-pagemap_2") @@ hightlight id_;_Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebCheckBox("selectLibraryGroup 3")_;_script infofile_;_ZIP::ssf269.xml_;_
Wait(10)
Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebCheckBox("selectLibraryGroup_3").Set "ON" @@ hightlight id_;_Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebButton("Next")_;_script infofile_;_ZIP::ssf270.xml_;_
Wait(10)
Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebButton("Next").Click @@ hightlight id_;_Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebEdit("usersTextBox")_;_script infofile_;_ZIP::ssf271.xml_;_
Wait(10)
Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebEdit("usersTextBox").Set "10" @@ hightlight id_;_Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebList("licenseTypeDropDown")_;_script infofile_;_ZIP::ssf272.xml_;_
Wait(10)
Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebList("licenseTypeDropDown").Select "Term" @@ hightlight id_;_Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebList("supportDropDown")_;_script infofile_;_ZIP::ssf273.xml_;_
Wait(10)
Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebEdit("licenseDateContainer:termExpDa").Check CheckPoint("licenseDateContainer:termExpDateField") @@ hightlight id_;_Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebEdit("licenseDateContainer:termExpDa")_;_script infofile_;_ZIP::ssf356.xml_;_
Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebEdit("licenseDateContainer:termExpDa").Click
Wait(5)
...
Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebElement("WebTable").Click
Wait(5)
Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebButton("Submit_2").Click @@ hightlight id_;_Browser("Browser").Page("Page").WebButton("Submit")_;_script infofile_;_ZIP::ssf275.xml_;_
Wait(10)
Browser("Browser").Page("Page").WebButton("Submit").Click
Browser("Browser").Page("Page").Sync @@ hightlight id_;_5440468_;_script infofile_;_ZIP::ssf276.xml_;_
Wait(10)
Browser("Browser").Dialog("Microsoft Internet Explorer").WinButton("OK").Click
Browser("Browser").Page("Page").Sync @@ hightlight id_;_Browser("Browser").Page("Page")_;_script infofile_;_ZIP::ssf277.xml_;_
Wait(10)
Browser("Browser").Page("Page").Check CheckPoint("Orders_6") @@ hightlight id_;_Browser("Browser").Page("Page").WebEdit("userId")_;_script infofile_;_ZIP::ssf112.xml_;_
Browser("Browser").Page("Page").Sync
...
' Expected Result  : Push Order should certainly push the order and also the Libraries associated with the Library, and status should change to Pushed @@ hightlight id_;_Browser("Browser").Page("Page").WebEdit("userId")_;_script infofile_;_ZIP::ssf112.xml_;_
Reporter.ReportEvent 2, "STEP 20 BEGINS","" @@ hightlight id_;_Browser("Browser").Page("Page").Link("Push Order 2")_;_script infofile_;_ZIP::ssf278.xml_;_

Browser("Browser").Page("Page").Link("Push Order_2").Click
Browser("Browser").Page("Page").Sync @@ hightlight id_;_5833684_;_script infofile_;_ZIP::ssf281.xml_;_
Wait(5)
Browser("Browser").Dialog("Microsoft Internet Explorer").WinButton("OK").Click @@ hightlight id_;_Browser("Browser").Page("Page").Link("Push Order 2")_;_script infofile_;_ZIP::ssf278.xml_;_
Wait(5)
Browser("Browser").Page("Page").Link("Push Order_3").Click
Browser("Browser").Page("Page").Sync @@ hightlight id_;_5833684_;_script infofile_;_ZIP::ssf281.xml_;_
Wait(5)
Browser("Browser").Dialog("Microsoft Internet Explorer").WinButton("OK").Click @@ hightlight id_;_Browser("Browser").Page("Page")_;_script infofile_;_ZIP::ssf284.xml_;_
Wait(5)
Browser("Browser").Page("Page").Check CheckPoint("Orders_7")
...
Reporter.ReportEvent 2, "STEP 21 BEGINS","" @@ hightlight id_;_Browser("Browser").Page("Page").Link("Logout")_;_script infofile_;_ZIP::ssf285.xml_;_
 @@ hightlight id_;_Browser("Browser").Page("Page")_;_script infofile_;_ZIP::ssf286.xml_;_
Browser("Browser").Page("Page").Link("Logout").Click
Browser("Browser").Page("Page").Sync
Browser("Browser").Close
'SystemUtil.Run "iexplore.exe","","","open" @@ hightlight id_;_Browser("Browser").Page("Page").WebEdit("userId")_;_script infofile_;_ZIP::ssf288.xml_;_
'Browser("Browser").Page("Page").Sync @@ hightlight id_;_Browser("Browser").Page("Page").WebEdit("password")_;_script infofile_;_ZIP::ssf289.xml_;_
'Browser("Browser").Navigate "http://i2361.ptcnet.ptc.com/automationhosted/" @@ hightlight id_;_Browser("Browser").Page("Page").Link("Login")_;_script infofile_;_ZIP::ssf290.xml_;_
'Browser("Browser").Page("Page").WebEdit("userId").Set "prof_pt_co3_usr_0200@ptcunoemail.com" @@ hightlight id_;_Browser("Browser").Page("Page")_;_script infofile_;_ZIP::ssf291.xml_;_
'Browser("Browser").Page("Page").WebEdit("password").SetSecure "481f39219a4f1b332a268cc889eb143a4b2d5635f180"
...
'                                     Note : Make sure that the available Licenses should be 10 , as what given during the Order Creation. @@ hightlight id_;_Browser("Browser").Page("Page").Link("Logout")_;_script infofile_;_ZIP::ssf285.xml_;_
Reporter.ReportEvent 2, "STEP 22 BEGINS","" @@ hightlight id_;_Browser("Browser").Page("Page").Link("Administration")_;_script infofile_;_ZIP::ssf292.xml_;_

Browser("Browser").Page("Page").Link("Administration").Click @@ hightlight id_;_Browser("Browser").Page("Page").Link("View & Assign Licenses")_;_script infofile_;_ZIP::ssf293.xml_;_
Browser("Browser").Page("Page").Sync
Browser("Browser").Page("Page").Link("View & Assign Licenses").Click @@ hightlight id_;_Browser("Browser").Page("Page")_;_script infofile_;_ZIP::ssf294.xml_;_
Browser("Browser").Page("Page").Sync
...
' Expected Result  : Users should get created with  Admin & User privilages and should be displayed in Manage Users page. @@ hightlight id_;_Browser("Browser").Page("Page").Link("Logout")_;_script infofile_;_ZIP::ssf285.xml_;_
Reporter.ReportEvent 2, "STEP 23 BEGINS","" @@ hightlight id_;_Browser("Browser").Page("Page").Link("Administration")_;_script infofile_;_ZIP::ssf296.xml_;_

Browser("Browser").Page("Page").Link("Administration").Click @@ hightlight id_;_Browser("Browser").Page("Page").Link("Manage Users")_;_script infofile_;_ZIP::ssf297.xml_;_
Browser("Browser").Page("Page").Sync
Browser("Browser").Page("Page").Link("Manage Users").Click @@ hightlight id_;_Browser("Browser").Page("Page").Link("Create New User")_;_script infofile_;_ZIP::ssf298.xml_;_
Browser("Browser").Page("Page").Sync
Browser("Browser").Page("Page").Link("Create New User").Click @@ script infofile_;_ZIP::ssf299.xml_;_
Browser("Browser").Page("Page").Sync
Browser("Browser").Page("Page").WebRadioGroup("view:radioGroup").Select "#0" @@ hightlight id_;_Browser("Browser").Page("Page").WebEdit("view:radioGroup:createSingleUs")_;_script infofile_;_ZIP::ssf300.xml_;_
Browser("Browser").Page("Page").Sync
Browser("Browser").Page("Page").WebEdit("view:radioGroup:createSingleUs").Set "prof_pt_co3_usr_0201@ptcunoemail.com" @@ hightlight id_;_Browser("Browser").Page("Page").Link("Add To List")_;_script infofile_;_ZIP::ssf301.xml_;_
Wait(5)
Browser("Browser").Page("Page").Link("Add To List").Click
Browser("Browser").Page("Page").Sync @@ hightlight id_;_Browser("Browser").Page("Page").WebEdit("view:radioGroup:createSingleUs")_;_script infofile_;_ZIP::ssf302.xml_;_
Wait(5)
Browser("Browser").Page("Page").WebEdit("view:radioGroup:createSingleUs").Set "prof_pt_co3_usr_0202@ptcunoemail.com" @@ hightlight id_;_Browser("Browser").Page("Page").Link("Add To List")_;_script infofile_;_ZIP::ssf303.xml_;_
Wait(5)
Browser("Browser").Page("Page").Link("Add To List").Click
Browser("Browser").Page("Page").Sync @@ hightlight id_;_Browser("Browser").Page("Page").WebEdit("view:radioGroup:createSingleUs")_;_script infofile_;_ZIP::ssf304.xml_;_
Wait(5)
Browser("Browser").Page("Page").WebEdit("view:radioGroup:createSingleUs").Set "prof_pt_co3_usr_0203@ptcunoemail.com" @@ hightlight id_;_Browser("Browser").Page("Page").Link("Add To List")_;_script infofile_;_ZIP::ssf305.xml_;_
Wait(5)
Browser("Browser").Page("Page").Link("Add To List").Click
Browser("Browser").Page("Page").Sync @@ hightlight id_;_Browser("Browser").Page("Page").WebEdit("view:radioGroup:createSingleUs")_;_script infofile_;_ZIP::ssf306.xml_;_
Wait(5)
Browser("Browser").Page("Page").WebEdit("view:radioGroup:createSingleUs").Set "prof_pt_co3_usr_0204@ptcunoemail.com" @@ hightlight id_;_Browser("Browser").Page("Page").Link("Add To List")_;_script infofile_;_ZIP::ssf307.xml_;_
Wait(5)
Browser("Browser").Page("Page").Link("Add To List").Click
Browser("Browser").Page("Page").Sync @@ hightlight id_;_Browser("Browser").Page("Page").WebEdit("view:radioGroup:createSingleUs")_;_script infofile_;_ZIP::ssf308.xml_;_
Wait(5)
Browser("Browser").Page("Page").WebEdit("view:radioGroup:createSingleUs").Set "prof_pt_co3_usr_0205@ptcunoemail.com" @@ hightlight id_;_Browser("Browser").Page("Page").Link("Add To List")_;_script infofile_;_ZIP::ssf309.xml_;_
Wait(5)
Browser("Browser").Page("Page").Link("Add To List").Click
Browser("Browser").Page("Page").Sync @@ hightlight id_;_Browser("Browser").Page("Page").WebEdit("view:radioGroup:createSingleUs")_;_script infofile_;_ZIP::ssf310.xml_;_
Wait(5)
Browser("Browser").Page("Page").WebEdit("view:radioGroup:createSingleUs").Set "prof_pt_co3_usr_0206@ptcunoemail.com" @@ hightlight id_;_Browser("Browser").Page("Page").Link("Add To List")_;_script infofile_;_ZIP::ssf311.xml_;_
Wait(5)
Browser("Browser").Page("Page").Link("Add To List").Click
Browser("Browser").Page("Page").Sync @@ hightlight id_;_Browser("Browser").Page("Page").WebEdit("view:radioGroup:createSingleUs")_;_script infofile_;_ZIP::ssf312.xml_;_
Wait(5)
Browser("Browser").Page("Page").WebEdit("view:radioGroup:createSingleUs").Set "prof_pt_co3_usr_0207@ptcunoemail.com" @@ hightlight id_;_Browser("Browser").Page("Page").Link("Add To List")_;_script infofile_;_ZIP::ssf313.xml_;_
Wait(5)
Browser("Browser").Page("Page").Link("Add To List").Click
Browser("Browser").Page("Page").Sync @@ hightlight id_;_Browser("Browser").Page("Page").WebEdit("view:radioGroup:createSingleUs")_;_script infofile_;_ZIP::ssf314.xml_;_
Wait(5)
Browser("Browser").Page("Page").WebEdit("view:radioGroup:createSingleUs").Set "prof_pt_co3_usr_0208@ptcunoemail.com" @@ hightlight id_;_Browser("Browser").Page("Page").Link("Add To List")_;_script infofile_;_ZIP::ssf315.xml_;_
Wait(5)
Browser("Browser").Page("Page").Link("Add To List").Click
Browser("Browser").Page("Page").Sync @@ hightlight id_;_Browser("Browser").Page("Page").WebEdit("view:radioGroup:createSingleUs")_;_script infofile_;_ZIP::ssf316.xml_;_
Wait(5)
Browser("Browser").Page("Page").WebEdit("view:radioGroup:createSingleUs").Set "prof_pt_co3_usr_0209@ptcunoemail.com" @@ hightlight id_;_Browser("Browser").Page("Page").Link("Add To List")_;_script infofile_;_ZIP::ssf317.xml_;_
Wait(5)
Browser("Browser").Page("Page").Link("Add To List").Click
Browser("Browser").Page("Page").Sync @@ hightlight id_;_Browser("Browser").Page("Page").WebEdit("view:radioGroup:createSingleUs")_;_script infofile_;_ZIP::ssf318.xml_;_
Wait(5)
Browser("Browser").Page("Page").WebEdit("view:radioGroup:createSingleUs").Set "prof_pt_co3_usr_0210@ptcunoemail.com" @@ hightlight id_;_Browser("Browser").Page("Page").Link("Add To List")_;_script infofile_;_ZIP::ssf319.xml_;_
Wait(5)
Browser("Browser").Page("Page").Link("Add To List").Click
Browser("Browser").Page("Page").Sync @@ hightlight id_;_Browser("Browser").Page("Page").Link("Next >")_;_script infofile_;_ZIP::ssf320.xml_;_
Wait(5)
Browser("Browser").Page("Page").Link("Next >").Click
Browser("Browser").Page("Page").Sync @@ hightlight id_;_Browser("Browser").Page("Page").Link("Edit Table")_;_script infofile_;_ZIP::ssf321.xml_;_
Wait(5)
Browser("Browser").Page("Page").Link("Edit Table").Click
Browser("Browser").Page("Page").Sync @@ hightlight id_;_Browser("Browser").Page("Page").WebCheckBox("view:form:usergroup")_;_script infofile_;_ZIP::ssf322.xml_;_
Wait(5)
Browser("Browser").Page("Page").WebCheckBox("view:form:usergroup").Set "ON" @@ hightlight id_;_Browser("Browser").Page("Page").WebCheckBox("view:form:usergroup 2")_;_script infofile_;_ZIP::ssf323.xml_;_
Wait(5)
Browser("Browser").Page("Page").WebCheckBox("view:form:usergroup_2").Set "ON" @@ hightlight id_;_Browser("Browser").Page("Page").WebCheckBox("view:form:usergroup 3")_;_script infofile_;_ZIP::ssf324.xml_;_
Wait(5)
Browser("Browser").Page("Page").WebCheckBox("view:form:usergroup_3").Set "ON" @@ hightlight id_;_Browser("Browser").Page("Page").WebCheckBox("view:form:usergroup 4")_;_script infofile_;_ZIP::ssf325.xml_;_
Wait(5)
Browser("Browser").Page("Page").WebCheckBox("view:form:usergroup_4").Set "ON" @@ hightlight id_;_Browser("Browser").Page("Page").WebCheckBox("view:form:usergroup 5")_;_script infofile_;_ZIP::ssf326.xml_;_
Wait(5)
Browser("Browser").Page("Page").WebCheckBox("view:form:usergroup_5").Set "ON" @@ hightlight id_;_Browser("Browser").Page("Page").Link("Bulk Edit")_;_script infofile_;_ZIP::ssf351.xml_;_
Wait(5)
Browser("Browser").Page("Page").Link("Bulk Edit").Click @@ hightlight id_;_Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebCheckBox("authrolescheck")_;_script infofile_;_ZIP::ssf327.xml_;_
Wait(10)
Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebCheckBox("authrolescheck").Set "ON" @@ hightlight id_;_Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebList("authroles")_;_script infofile_;_ZIP::ssf328.xml_;_
Wait(5)
Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebList("authroles").Select "Admin" @@ hightlight id_;_Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").Link("OK")_;_script infofile_;_ZIP::ssf329.xml_;_
Wait(5)
Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").Link("OK").Click @@ hightlight id_;_Browser("Browser").Page("Page").Link("Next >")_;_script infofile_;_ZIP::ssf330.xml_;_
Wait(5)
Browser("Browser").Page("Page").Link("Next >").Click
Browser("Browser").Page("Page").Sync @@ hightlight id_;_Browser("Browser").Page("Page").Link("Next >")_;_script infofile_;_ZIP::ssf331.xml_;_
Wait(5)
Browser("Browser").Page("Page").Link("Next >").Click
Browser("Browser").Page("Page").Sync @@ hightlight id_;_Browser("Browser").Page("Page").WebRadioGroup("view:sendNotificationForm:grou")_;_script infofile_;_ZIP::ssf332.xml_;_
Wait(5)
Browser("Browser").Page("Page").WebRadioGroup("view:sendNotificationForm:grou").Select "#1"
Browser("Browser").Page("Page").Sync @@ hightlight id_;_Browser("Browser").Page("Page").Link("Finish")_;_script infofile_;_ZIP::ssf333.xml_;_
Wait(5)
Browser("Browser").Page("Page").Link("Finish").Click @@ hightlight id_;_Browser("Browser").Page("Page")_;_script infofile_;_ZIP::ssf334.xml_;_
Browser("Browser").Page("Page").Sync
Browser("Browser").Page("Page").Check CheckPoint("Manage Users")
...
Reporter.ReportEvent 2, "STEP 24 BEGINS","" @@ hightlight id_;_Browser("Browser").Page("Page").Link("Administration")_;_script infofile_;_ZIP::ssf335.xml_;_

Browser("Browser").Page("Page").Link("Administration").Click @@ hightlight id_;_Browser("Browser").Page("Page").Link("View & Assign Licenses")_;_script infofile_;_ZIP::ssf336.xml_;_
Browser("Browser").Page("Page").Sync
Browser("Browser").Page("Page").Link("View & Assign Licenses").Click @@ hightlight id_;_Browser("Browser").Page("Page")_;_script infofile_;_ZIP::ssf337.xml_;_
Browser("Browser").Page("Page").Sync
Browser("Browser").Page("Page").Check CheckPoint("View & Assign Licenses_4")
Browser("Browser").Page("Page").Sync @@ hightlight id_;_Browser("Browser").Page("Page").Image("details-active")_;_script infofile_;_ZIP::ssf338.xml_;_
Wait(5)
Browser("Browser").Page("Page").Image("assign-active").Click
Browser("Browser").Page("Page").Sync @@ hightlight id_;_Browser("Browser").Page("Page").Link("Select Users")_;_script infofile_;_ZIP::ssf339.xml_;_
Wait(5)
Browser("Browser").Page("Page").Link("Select Users").Click
Browser("Browser").Page("Page").Sync @@ hightlight id_;_Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebCheckBox("WebCheckBox")_;_script infofile_;_ZIP::ssf340.xml_;_
Wait(5)
Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebCheckBox("WebCheckBox").Set "ON" @@ hightlight id_;_Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebCheckBox("usergroup")_;_script infofile_;_ZIP::ssf341.xml_;_
Wait(5)
Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebCheckBox("usergroup").Set "OFF" @@ hightlight id_;_Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").Link("OK")_;_script infofile_;_ZIP::ssf342.xml_;_
Wait(5)
Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").Link("OK").Click @@ hightlight id_;_Browser("Browser").Page("Page").Link("Next >")_;_script infofile_;_ZIP::ssf343.xml_;_
Wait(5)
Browser("Browser").Page("Page").Link("Next >").Click
Browser("Browser").Page("Page").Sync @@ hightlight id_;_Browser("Browser").Page("Page").WebRadioGroup("view:sendNotificationForm:grou")_;_script infofile_;_ZIP::ssf344.xml_;_
Wait(5)
Browser("Browser").Page("Page").WebRadioGroup("view:sendNotificationForm:grou").Select "#1"
Browser("Browser").Page("Page").Sync @@ hightlight id_;_Browser("Browser").Page("Page").Link("Finish")_;_script infofile_;_ZIP::ssf345.xml_;_
Wait(5)
Browser("Browser").Page("Page").Link("Finish").Click
Browser("Browser").Page("Page").Sync @@ hightlight id_;_Browser("Browser").Page("Page").Image("details-active")_;_script infofile_;_ZIP::ssf346.xml_;_
Wait(5)
Browser("Browser").Page("Page").Image("details-active").Click
Browser("Browser").Page("Page").Sync @@ hightlight id_;_Browser("Browser").Page("Page")_;_script infofile_;_ZIP::ssf347.xml_;_
Wait(5)
Browser("Browser").Page("Page").Check CheckPoint("License Deatils_3")
Browser("Browser").Page("Page").Sync @@ hightlight id_;_Browser("Browser").Page("Page").Link("Back")_;_script infofile_;_ZIP::ssf348.xml_;_
Wait(5)
Browser("Browser").Page("Page").Link("Back").Click
Browser("Browser").Page("Page").Sync @@ hightlight id_;_Browser("Browser").Page("Page").Link("Administration")_;_script infofile_;_ZIP::ssf349.xml_;_
Wait(5) @@ hightlight id_;_Browser("Browser").Page("Page")_;_script infofile_;_ZIP::ssf355.xml_;_
Browser("Browser").Page("Page").Link("Administration").Click @@ hightlight id_;_Browser("Browser").Page("Page").Link("Log Out")_;_script infofile_;_ZIP::ssf354.xml_;_
