'File Name: sc_TC1_Licen(Perptl)_Ord_With_Suppt
...
Browser("Browser").Page("Page").Sync
Browser("Browser").Page("Page").Link("Show all Organizations").Click @@ hightlight id_;_Browser("Browser").Page("Page").Link("Show all Organizations")_;_script infofile_;_ZIP::ssf371.xml_;_
Browser("Browser").Page("Page").Sync
...
'                                 All the License Details should set as mentioned below,Number Of Users =10,License Type = Perpetual,Support  = Yes,Support Exp Date = future date to the current date.
...
Wait(10)
Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebList("supportDropDown").Select "Yes" @@ hightlight id_;_Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebList("supportDropDown")_;_script infofile_;_ZIP::ssf253.xml_;_
Wait(10)
Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebEdit("supportDateContainer:supportEx").Check CheckPoint("supportDateContainer:supportExpDateField") @@ hightlight id_;_Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebEdit("supportDateContainer:supportEx")_;_script infofile_;_ZIP::ssf363.xml_;_
Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebEdit("supportDateContainer:supportEx").Click @@ hightlight id_;_Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebList("select")_;_script infofile_;_ZIP::ssf364.xml_;_
Wait(5)
Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebList("select").Click @@ hightlight id_;_Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebList("select")_;_script infofile_;_ZIP::ssf358.xml_;_
Wait(5)
Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebList("select").Select "December" @@ hightlight id_;_Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebList("select")_;_script infofile_;_ZIP::ssf357.xml_;_
Wait(5)
Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebList("select_2").Click @@ hightlight id_;_Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebList("select 2")_;_script infofile_;_ZIP::ssf359.xml_;_
Wait(5)
Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebList("select_2").Select "2018" @@ hightlight id_;_Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebList("select 2")_;_script infofile_;_ZIP::ssf360.xml_;_
Wait(5)
Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebElement("WebTable").Click @@ hightlight id_;_Browser("Browser").Page("Page").Frame("modal-dialog-pagemap").WebElement("WebTable")_;_script infofile_;_ZIP::ssf362.xml_;_
Wait(5)
