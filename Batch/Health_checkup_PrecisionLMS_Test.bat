...
"C:\Program Files\HP\QuickTest Professional\bin\MultiTestManager.exe"  /TB "D:\Fusion_QA\Automation\Batch\Health_checkup_PrecisionLMS_Test.mtm" /CLOSE_QTP /CLOSE_MTM /LOG /SUMMARY