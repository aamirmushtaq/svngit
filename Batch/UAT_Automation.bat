...
"C:\Program Files\Mercury Interactive\QuickTest Professional\bin\MultiTestManager.exe"  /TB "D:\Fusion_QA\Automation\Batch\UAT_Scripts_Batch.mtm" /CLOSE_QTP /CLOSE_MTM /LOG /SUMMARY