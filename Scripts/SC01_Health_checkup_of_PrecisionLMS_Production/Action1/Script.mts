...
rc=OpenApplication("https://precisionlms.ptc.com/", blnRet) 'Opening a new browser
...
wait(5)
Browser("Browser").Page("Page").WebList("version").Select "Wildfire 4.0" @@ hightlight id_;_Browser("Browser").Page("Page").WebList("version")_;_script infofile_;_ZIP::ssf220.xml_;_
Browser("Browser").Page("Page").WebButton("search").Click @@ hightlight id_;_Browser("Browser").Page("Page").WebButton("search")_;_script infofile_;_ZIP::ssf221.xml_;_
Browser("Browser").Page("Page").Sync
wait(5)
