...
exp system/ptcse@auto1 owner=plms_auto1 file=%backup_file_plms% statistics=none consistent=y
...
exp system/ptcse@auto1 owner=ipa_auto1 file=%backup_file_ipa% statistics=none consistent=y
