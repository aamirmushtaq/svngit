update setting_value set value='http://i5696-vm2.ptcnet.ptc.com/plms/app/pages/?wicket:bookmarkablePage=:com.ptc.fusion.web.pages.user.ApproveUsers' where setting_key='app.approver_url';
...
update setting_value set value='ptcu_test_engineering@ptc.com' where setting_key='app.ldap_sync_error_email';
update setting_value set value='http://i5696-vm2.ptcnet.ptc.com/plms/app/?wicket:bookmarkablePage=:com.ptc.fusion.web.pages.ChangePassword' where setting_key='app.local_chg_passwd_link';
update setting_value set value='http://i5696-vm2.ptcnet.ptc.com/plms/app/pages/Login' where setting_key='app.login_page_url';
update setting_value set value='schauhan2d.ptcnet.ptc.com' where setting_key='app.proeSkillNode';
...
update setting_value set value='/usr1/seuser/d00/content/plms/data/content' where setting_key='content.content_package_storage_location';
...
update setting_value set value='ptcu_test_engineering@ptc.com' where setting_key='mail.from_addr';
update setting_value set value='ptcu_test_engineering@ptc.com' where setting_key='mail.grading_err_addr';
update setting_value set value='int-mail.ptc.com' where setting_key='mail.host';
update setting_value set value='hq-fusdev03.ptcnet.ptc.com' where setting_key='proegrading.dsm_host_name';
update setting_value set value='ptcu_test_engineering@ptc.com' where setting_key='proegrading.ge_error_notification_mailid';
