...
set backup_file_plms=backup_plms_2.dmp
set backup_file_ipa=backup_ipa_2.dmp


@echo Backing up automation to %backup_file_plms% ...

exp system/ptcse@auto1 owner=automation_plms file=%backup_file_plms% statistics=none consistent=y
