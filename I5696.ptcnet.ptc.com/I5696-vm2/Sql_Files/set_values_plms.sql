update setting_value set value='http://I5059-vm6.ptcnet.ptc.com/plms/app/pages/?wicket:bookmarkablePage=:com.ptc.fusion.web.pages.user.ApproveUsers' where setting_key='app.approver_url';
...
update setting_value set value='http://I5059-vm6.ptcnet.ptc.com/plms/app/?wicket:bookmarkablePage=:com.ptc.fusion.web.pages.ChangePassword' where setting_key='app.local_chg_passwd_link';
update setting_value set value='http://I5059-vm6.ptcnet.ptc.com/plms/app/pages/Login' where setting_key='app.login_page_url';
update setting_value set value='http://I5059-vm6.ptcnet.ptc.com' where setting_key='app.proeSkillNode';
